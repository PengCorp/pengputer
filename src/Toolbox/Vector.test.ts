...
describe("Vector", () => {
    ...
    describe("vectorSubtract", () => {
        test("subtracts components", () => {
            expect(
                vectorSubtract({ x: 5, y: 7 }, { x: 2, y: 3 }),
            ).toStrictEqual({
                x: 3,
                y: 4,
            });
    ...
    describe("vectorDivideByNumberFloored", () => {
        test("divides and floors", () => {
            expect(
                vectorDivideByNumberFloored({ x: 7, y: 9 }, 2),
            ).toStrictEqual({
                x: 3,
                y: 4,
            });
    ...
    describe("vectorClamp", () => {
        test("inside rect unchanged", () => {
            expect(
                vectorClamp({ x: 5, y: 5 }, { x: 0, y: 0, w: 10, h: 10 }),
            ).toStrictEqual({ x: 5, y: 5 });
        });

        test("clamps to rect bounds", () => {
            expect(
                vectorClamp({ x: -5, y: 20 }, { x: 0, y: 0, w: 10, h: 10 }),
            ).toStrictEqual({ x: 0, y: 9 });
        });
    });
    ...
    describe("getRectWithPosition", () => {
        test("moves rect to new position", () => {
            ...
            ).toStrictEqual({ x: 5, y: 6, w: 10, h: 20 });
        });
    });
    ...
    describe("getRectMovedBy", () => {
        test("offsets rect position", () => {
            expect(
                getRectMovedBy({ x: 1, y: 2, w: 10, h: 20 }, { x: 3, y: 4 }),
            ).toStrictEqual({ x: 4, y: 6, w: 10, h: 20 });
        });
    });
