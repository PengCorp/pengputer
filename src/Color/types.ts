export enum CgaColors {
  ...
  BackgroundChartreuse = "backgroundChartreuse",
  BackgroundSpringGreen = "backgroundSpringGreen",
  BackgroundAzure = "backgroundAzure",
  BackgroundViolet = "backgroundViolet",
  BackgroundRose = "backgroundRose",
